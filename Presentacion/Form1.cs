...
namespace Presentacion
{
    public partial class Forma : Form
    {
        ...
        private void btnVerAlumnos_MouseEnter(object sender, EventArgs e)
        {
            btnVerAlumnos.BackColor = Color.LightBlue;
        }

        private void btnVerAlumnos_MouseLeave(object sender, EventArgs e)
        {
            btnVerAlumnos.BackColor = Color.MintCream;
        }

        private void btnVerMaterias_MouseEnter(object sender, EventArgs e)
        {
            btnVerMaterias.BackColor = Color.LightBlue;
        }

        private void btnVerMaterias_MouseLeave(object sender, EventArgs e)
        {
            btnVerMaterias.BackColor = Color.MintCream;
        }

        private void btnVerMaestros_MouseEnter(object sender, EventArgs e)
        {
            btnVerMaestros.BackColor = Color.LightBlue;
        }

        private void btnVerMaestros_MouseLeave(object sender, EventArgs e)
        {
            btnVerMaestros.BackColor = Color.MintCream;
        }

        private void btnVerSecretario_MouseEnter(object sender, EventArgs e)
        {
            btnVerSecretario.BackColor = Color.LightBlue;
        }

        private void btnVerSecretario_MouseLeave(object sender, EventArgs e)
        {
            btnVerSecretario.BackColor = Color.MintCream;
        }

        private void btnVerCalificaciones_MouseEnter(object sender, EventArgs e)
        {

            btnVerCalificaciones.BackColor = Color.LightBlue;
        }

        private void btnVerCalificaciones_MouseLeave(object sender, EventArgs e)
        {

            btnVerCalificaciones.BackColor = Color.MintCream;
        }

        private void btnVerHistorial_MouseEnter(object sender, EventArgs e)
        {
            btnVerHistorial.BackColor = Color.LightBlue;
        }

        private void btnVerHistorial_MouseLeave(object sender, EventArgs e)
        {
            btnVerHistorial.BackColor = Color.MintCream;
        }
